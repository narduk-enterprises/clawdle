...
Existing apps receive the same repo assets through the platform-controlled
sync flow or a fresh starter export. Do not copy the files manually. The
remaining platform step is to add or update the repo manifest in
